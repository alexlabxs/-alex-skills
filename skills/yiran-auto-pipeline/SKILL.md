...
3. **Step 3 生成配图** — 根据 series 字段自动选 IP：
   ...
   - **每张图生成后立即用对应 IP 的 QA checklist 验证**：
     - 小点检查：光晕颜色匹配主题？小点是指引不是装饰？去掉光晕重点还在？
     - 小黑检查：小黑是核心动作？画面≤60%？无左上角标题？无纸纹渐变？
   - **不通过的图立即重生成**，不等到最后
...
| # | 场景 | IP 动作 | 结构类型 |
|:-:|------|---------|---------|
| 🖼️ 封面 | 小兔子站树下看蛋 | 小点照亮三颗蛋 | 角色状态 |
| ❶ | 小兔子撞树枝蛋坠落 | 小点躲在树枝后 | 前后对比 |
| ❷ | 小兔子垂耳承认 | 小点发光在耳边 | 角色状态 |
| ❸ | 小鸟妈妈拥抱 | 小点放大光晕包围 | 概念隐喻 |
| ❹ | 朋友们做新窝 | 小点变一串光点流动 | 系统局部 |
